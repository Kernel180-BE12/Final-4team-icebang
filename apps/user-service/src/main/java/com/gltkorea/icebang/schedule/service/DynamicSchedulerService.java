    ...
    public void register(Schedule schedule) {
        ...
        Runnable runnable = () -> {
            try {
                ...
                log.error("Failed to run scheduled job for scheduleId: {}", schedule.getScheduleId(), e);
            }
        };
        ...
        log.info(">>>> Schedule registered: id={}, cron={}", schedule.getScheduleId(), schedule.getCronExpression());
    }
