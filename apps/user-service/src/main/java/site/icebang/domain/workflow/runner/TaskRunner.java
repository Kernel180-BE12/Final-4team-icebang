 ...
 *
 * <p>이 인터페이스는 전략 패턴(Strategy Pattern)의 '전략(Strategy)' 역할을 수행합니다.
 * {@code WorkflowExecutionService}는 이 인터페이스에 의존하여, Task의 타입('FastAPI' 등)에 따라
 * 적절한 Runner 구현체를 선택하고 실행 로직을 위임합니다.
 *
 * <h2>주요 구성 요소:</h2>
 * <ul>
 * <li><b>TaskExecutionResult</b>: 모든 Task 실행 결과가 따라야 할 표준 응답 형식을 정의하는 내부 Record</li>
 * <li><b>execute</b>: Task 실행을 위한 단일 추상 메소드</li>
 * </ul>
 *
