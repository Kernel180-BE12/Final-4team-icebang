...
@Sql(scripts = {"classpath:sql/create-schema.sql", "classpath:sql/insert-user-data.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
class DatabaseConnectionTest {
    ...
    @Autowired
    private UserMapper userMapper; // JPA Repository 대신 MyBatis Mapper를 주입
